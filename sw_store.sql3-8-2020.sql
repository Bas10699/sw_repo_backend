...
--
-- Host: localhost
-- Generation Time: Mar 08, 2020 at 01:22 PM
...
CREATE TABLE `calendar_notes` (
  ...
  `cn_color` int NOT NULL DEFAULT '0',
  `cn_head` varchar(45) NOT NULL,
  `cn_item_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(27, '2020-03-05', '16:00:00', '22', 1, 'PTZ10W', 9);
...
INSERT INTO `item_store` (`item_id`, `item_name`, `item_series_number`, `item_date_of_birth`, `item_image`, `item_place_of_birth`, `item_brand`, `item_gen`, `item_status`, `item_type`, `item_airport`, `item_airport_date`, `item_notes`) VALUES
(4, 'camera', '444444', '2020-03-13', 'item/image/item_4.png', 'america', 'SONY', '111', 2, 1, 2, '2020-03-04', 'ส่งซ่อมอยู่ที่บริ '),
(6, 'RAYMARINE & FLIR THERMAL CAMERAS', '232526', '2020-03-19', 'item/image/item_6.png', 'America', 'FLIR', '001', 1, 2, 0, '2020-03-18', '44545454'),
(7, 'CM-3102-11-I', '444444', '2020-03-26', 'item/image/item_7.png', 'America', '121212', '44', 1, 3, 1, '2020-03-04', ''),
(9, 'PTZ10W', '45789512', '2020-03-27', 'item/image/item_9.png', '2020-03-18', 'FLIR', 'PT-612 HD', 1, 6, 1, '2020-03-05', ''),
(10, 'komet633', '112', '2020-03-20', 'item/image/item_10.png', 'Thailand', 'toyota', 'รุ่น10', 2, 1, 1, '2020-03-16', ''),
...
(25, 'VLDT6M 2MP', '111112', '2020-03-17', 'item/image/item_25.png', 'Japan', 'FLIR', '001', 1, 3, 2, '2020-03-03', ''),
(26, 'Ultra Long Zoom IR Laser PTZ themal', '125220', '2020-03-11', 'item/image/item_26.png', 'America', 'FLIR', '001', 3, 1, 2, '2020-03-03', ''),
(27, 'asdasd', '10101010', '2020-03-19', 'item/image/item_27.png', 'japan', '1010', '1010', 2, 2, 2, '2020-03-03', '03-05-2020\r\n  ส่งซ่อมอยู่ที่บริษัท\r\n03-09-2020\r\nส่งกลับสนามบินสุวรรณภมิ\r\n');
...
--
ALTER TABLE `airport`
  MODIFY `ap_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `calendar_notes`
--
ALTER TABLE `calendar_notes`
  MODIFY `cn_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `typename`
  MODIFY `TN_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
